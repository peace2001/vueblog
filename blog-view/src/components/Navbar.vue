  ...
  <div class="blog-navbar" :class="{'transparent':$route.name==='Home' }">
    ...
    <router-link style="text-decoration-line: none;color: white" to="/">
      <h3 :class="{'m-mobile-show': mobileHide,'active':$route.name==='About'}"
          class="ui header item m-blue" style="display: inline;padding:20px 20px 20px 60px">蘑菇汤
        </h3>
    </router-link>
    ...
    <el-button  round :class="{'m-mobile-show': mobileHide}" @click="$router.push('/UserLogin')" class="item" style="text-decoration-line: none;color: black;padding: 10px;margin-left: 480px">登 录||注册</el-button>
...
<!--    <router-link :class="{'m-mobile-show': mobileHide,'active':$route.name==='UserLogin'}" class="item" style="text-decoration-line: none;color: white;padding:380px"-->
<!--                 to="/userLogin">-->
<!--      登录||注册-->
<!--    </router-link>-->
