<template>
  <div class="card">
    ...
    <div class="card-header">
      <el-avatar :size="50" >
        <img src="@/assets/haha.jpg" alt="">
      </el-avatar>
      <p style="margin-top: 0px;">蘑菇汤</p>
    ...
    <div class="card-footer">
      <el-collapse>
        <el-collapse-item name="1" style="padding-left: 20px;padding-right: 20px" title="个人介绍">
          <div>超级无敌暴龙战士</div>
        </el-collapse-item>
...
export default {
  ...
  methods: {
    //跳转到个人github
    goToGithub() {
      window.location.href = "https://github.com/peace2001/"
    }
  },
  created() {
  }
