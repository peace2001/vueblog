<template>
  <div style="height: 100vh; display: flex; align-items: center; justify-content: center; background-color: #13c699">
        ...
        if (valid) {
          this.$axios.post('login', this.user).then(res => {
            ...
            if (res.data.code === 200) {
              ...
              localStorage.setItem("honey-user", JSON.stringify(res.data.data))  // 存储用户数据
            } else {
